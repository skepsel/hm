...
def description_filter(transactions: list, word: str) -> list:
    ...
    и слово по которому надо фильтровать описание транзакций
...
def category_count(transactions: list, categories: list) -> dict:
    """Принимает список словарей с транзакциями и список с категориями описаний
    выводит сколько транзакций с такими описаниями"""
